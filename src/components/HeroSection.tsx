...
export default function HeroSection() {
  return (
    <section className="scroll-mt-24 overflow-x-hidden bg-surface" id="home">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-5 px-4 pt-20 pb-8 sm:px-6 sm:pt-24 sm:pb-12 md:min-h-screen md:flex-row md:gap-20 md:px-8 md:pt-32 md:pb-24">
      <div className="w-full space-y-5 md:w-3/5 md:space-y-10">
        <div className="flex items-start justify-between gap-4 md:block">
          <div className="space-y-3 md:space-y-4">
            ...
            <h1 className="font-headline text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tighter leading-[1.05] text-on-background">
              Trishit<br />
              <span className="text-primary-dim">Swarnakar</span>
            </h1>
            <p className="max-w-xs text-sm leading-relaxed text-on-surface-variant sm:max-w-sm sm:text-base md:hidden">
              I build AI assistants and full-stack products focused on practical use.
            </p>
          </div>
          <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-lg bg-surface-container-highest shadow-lg md:hidden">
            <Image
        ...
        <div className="w-full rounded-lg border border-outline-variant/15 bg-surface-container-low px-3 py-2.5 sm:hidden">
          <p className="mb-1 font-label text-[10px] uppercase tracking-[0.1em] text-on-surface-variant">Current Focus</p>
          <p className="text-sm font-semibold leading-snug text-on-surface">AI assistants and full-stack products focused on practical use.</p>
          <p className="mt-1 text-[11px] font-medium text-on-surface-variant">Based in Delhi, India</p>
        </div>
        <div className="hidden flex-col items-start gap-5 border-t border-outline-variant/15 pt-8 sm:flex sm:flex-row sm:items-center sm:gap-8 sm:pt-10 md:pt-12">
          <div>
