      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:gap-y-14 md:grid-cols-2 md:gap-y-16 md:gap-x-12 lg:gap-x-16">
          ...
          <div className="group flex flex-col">
            <a
              aria-label="Open Ryoku project"
              className="block aspect-video bg-surface-container-low rounded-xl overflow-hidden mb-8 transition-transform duration-500 group-hover:-translate-y-2 relative p-4 md:p-6"
              href="https://ryoku-iota.vercel.app/"
              rel="noreferrer noopener"
              target="_blank"
              title="Open Ryoku project"
            >
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center space-x-2">
                  <span className="text-[10px] font-bold tracking-widest uppercase text-on-surface-variant px-2 py-1 bg-surface-container-highest rounded">Support OS</span>
                  <span className="text-[10px] font-bold tracking-widest uppercase text-primary">2026</span>
                </div>
                <span className="text-[10px] font-bold text-on-surface-variant">SAAS PLATFORM</span>
              </div>
              <div className="flex items-center gap-3 md:gap-4">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold text-on-surface group-hover:text-primary transition-colors leading-none">Ryoku</h3>
                <a href="https://github.com/Trishix/ryoku" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-primary transition-all hover:scale-110 active:scale-95 duration-200" aria-label="Ryoku GitHub Repository" title="GitHub Repository">
              ...
              <p className="text-on-surface-variant text-base leading-relaxed">
                An AI customer-support operating system that lets businesses create branded bots, ingest knowledge, and manage conversations.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start text-sm text-on-surface">
                  ...
                  Embeddable chat widget with RAG-powered automated responses
                </li>
                <li className="flex items-start text-sm text-on-surface">
                  <span className="material-symbols-outlined text-primary text-lg mr-2">check_circle</span>
                  Real-time human-agent handoff with comprehensive analytics dashboard
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="group flex flex-col">
            <a
              aria-label="Open VFlow project"
              className="block aspect-video bg-surface-container-low rounded-xl overflow-hidden mb-8 transition-transform duration-500 group-hover:-translate-y-2 relative p-4 md:p-6"
              href="https://vflow-project.vercel.app/"
              rel="noreferrer noopener"
              target="_blank"
              title="Open VFlow project"
            >
              <div className="relative w-full h-full">
                <Image
                  alt="VFlow Interface"
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center space-x-2">
                  <span className="text-[10px] font-bold tracking-widest uppercase text-on-surface-variant px-2 py-1 bg-surface-container-highest rounded">Workflow Builder</span>
                  <span className="text-[10px] font-bold tracking-widest uppercase text-primary">2026</span>
                </div>
                <span className="text-[10px] font-bold text-on-surface-variant">AI TOOLING</span>
              </div>
              <div className="flex items-center gap-3 md:gap-4">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold text-on-surface group-hover:text-primary transition-colors leading-none">VFlow</h3>
                <a href="https://github.com/Trishix/vflow" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-primary transition-all hover:scale-110 active:scale-95 duration-200" aria-label="VFlow GitHub Repository" title="GitHub Repository">
                  <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" fill="currentColor">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                  </svg>
                </a>
              ...
              <p className="text-on-surface-variant text-base leading-relaxed">
                A node-based AI workflow builder that enables you to create, customize, and reuse AI-powered workflows entirely in your browser.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start text-sm text-on-surface">
                  <span className="material-symbols-outlined text-primary text-lg mr-2">check_circle</span>
                  Connect prompts, AI models, and data nodes without writing code
                </li>
                <li className="flex items-start text-sm text-on-surface">
                  <span className="material-symbols-outlined text-primary text-lg mr-2">check_circle</span>
                  Interactive visual canvas for building complex automation flows
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-y-12 gap-x-8 sm:gap-y-14 md:grid-cols-2 md:gap-y-16 md:gap-x-12 lg:gap-x-16">
            ...
            <div className="group flex flex-col">
              <a
                ...
                className="block aspect-video bg-surface-container-low rounded-xl overflow-hidden mb-6 transition-transform duration-500 group-hover:-translate-y-2 relative p-4 md:p-6"
